    ...
    <div class="chat-container" :class="{ 'chat-container-expanded': chatExpanded }">
      <div class="chat-header">
        ...
        <button @click="toggleDialogSize" class="toggle-dialog-button">
          ...
          <img v-else class="me-1 node-icon" src="../../assets/img/cha-bubbles-two-svgrepo-com.svg" style="width: 37px; height: 37px; filter: invert(100%);">
        </button>
      </div>
...
.chat-container:not(.chat-container-expanded) {
  right: -345px; /* 或其他您覺得合適的值，以隱藏在視窗外 */
  bottom: -515px; /* 或其他您覺得合適的值，以隱藏在視窗外 */
}
